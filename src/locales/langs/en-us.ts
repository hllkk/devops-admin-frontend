const local: App.I18n.Schema = {
  ...
  route: {
    ...
    disk: 'Disk',
    server: 'Overview',
    'server-manage': 'Server Assets',
    'server-manage_monitor': 'Monitor',
    'server-manage_server-list': 'Server Management',
    'server-manage_server-detail': 'Server Detail',
    ...
    'notice-user': 'Notice View',
    'adminNoticeUser': 'Notice View',
    'diskNoticeUser': 'Notice View',
    log: 'Log Management',
    log_login: 'Login Log',
    ...
    manage_log_operation: 'Operate Log',
  ...
  page: {
    ...
    disk: {
      ...
      share: {
        ...
        customAddressPlaceholder: 'Custom share address',
        createShare: 'Create Share',
        resultTitle: 'Share Created Successfully',
        shareLink: 'Share Link',
        copyExtractionCode: 'Copy Code',
        copyShareText: 'Copy Share Text',
        cancelShare: 'Cancel Share',
        cancelSuccess: 'Share cancelled successfully',
        close: 'Close',
        createSuccess: 'Share link generated',
        shareTextTemplate: 'I shared a file with you. Click the link to view: {link} Code: {code}',
        forever: 'Forever',
        oneDay: '1 Day',
        sevenDays: '7 Days',
        thirtyDays: '30 Days',
        ...
        existingShareTip: 'This file already has a link share. Please use the existing link',
        codeFormat: 'Letters and numbers only, 4-8 characters',
        addressFormat: 'Letters and numbers only, 2-20 characters',
        ...
        permDelete: 'Delete',
        permUpload: 'Upload',
        shareForm: 'Share Type',
        shareFormPublic: 'Public Link',
        shareFormPrivate: 'Private Link',
      ...
      sharedWithMe: {
        ...
        roleOwner: 'Owner',
        permHintViewer: 'Can view and download files',
        permHintEditor: 'Can view, download, upload, edit and delete files',
        saveAsIndependentCopy: 'Save as an independent copy: independent of the source file',
        ...
        closeCurrentVideo: 'Please close the current video first',
  ...
  form: {
    ...
    pwd: {
      required: 'Please enter password',
      invalid: 'At least 8 characters, must include uppercase, lowercase, digit, and special character'
    },
    confirmPwd: {
