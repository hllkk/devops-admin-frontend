const local: App.I18n.Schema = {
  ...
  route: {
    ...
    server: '概览',
    'server-manage': '服务器资产',
    'server-manage_monitor': '监控大屏',
    'server-manage_server-list': '服务器管理',
    'server-manage_server-detail': '服务器详情',
  ...
  page: {
    ...
    disk: {
      ...
      share: {
        ...
        regenerate: '换一个',
        customAddress: '自定义地址',
        customAddressPlaceholder: '自定义分享地址',
        createShare: '创建分享',
        resultTitle: '分享创建成功',
        shareLink: '分享链接',
        copyExtractionCode: '复制提取码',
        copyShareText: '复制口令',
        cancelShare: '取消共享',
        cancelSuccess: '取消共享成功',
        close: '关闭',
        createSuccess: '分享链接已生成',
        shareTextTemplate: '我分享了一个文件给你，点击链接查看：{link} 提取码：{code}',
        forever: '永久',
        oneDay: '1天',
        sevenDays: '7天',
        thirtyDays: '30天',
        shareSuccess: '共享成功',
        linkShare: '链接分享',
        existingShareTip: '当前文件已有链接分享，请直接使用现有链接',
        codeFormat: '仅支持字母和数字，4-8位',
        addressFormat: '仅支持字母和数字，2-20位',
        linkPreview: '链接预览',
        selectUser: '选择用户',
        searchUser: '搜索用户',
        batchSet: '批量设置',
      ...
      sharedWithMe: {
        ...
        from: '来自',
        folderEmpty: '文件夹为空',
        previewNotSupported: '暂不支持预览此类型文件',
        ...
        roleEditor: '可读写',
        roleOwner: '所有者',
        permHintViewer: '可查看和下载文件',
        permHintEditor: '可查看、下载、上传、编辑和删除文件',
        saveAsIndependentCopy: '保存为独立副本：与源文件互不影响',
        permDownload: '下载',
        permDelete: '删除',
        permShare: '分享',
        image: '图片',
