      ...
      <NCollapseItem :title="$t('common.search')" name="provider-search">
        <NForm ref="formRef" :model="model" label-placement="left" :label-width="90">
          <NGrid responsive="screen" item-responsive>
            <NFormItemGi span="24 s:12 m:6" label="供应商名称" path="name" class="pr-24px">
              <NInput v-model:value="model.name" placeholder="请输入供应商名称" />
            </NFormItemGi>
            <NFormItemGi span="24 s:12 m:6" label="供应商类型" path="providerType" class="pr-24px">
              <NInput v-model:value="model.providerType" placeholder="请输入供应商类型" />
            </NFormItemGi>
            <NFormItemGi span="24 s:12 m:6" label="状态" path="isActive" class="pr-24px">
              <NSelect v-model:value="isActiveSelect" placeholder="请选择状态" :options="isActiveOptions" clearable />
            </NFormItemGi>
