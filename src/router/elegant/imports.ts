...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  "notice-user": () => import("@/views/_builtin/notice-user/index.vue"),
  ...
  "gateway-ai-keys": () => import("@/views/gateway-ai-keys/index.vue"),
  "gateway-projects": () => import("@/views/gateway-projects/index.vue"),
  "gateway-providers": () => import("@/views/gateway-providers/index.vue"),
  gateway: () => import("@/views/gateway/index.vue"),
  ...
  "server-manage_server-detail": () => import("@/views/server-manage/server-detail/index.vue"),
  "server-manage_server-list": () => import("@/views/server-manage/server-list/index.vue"),
