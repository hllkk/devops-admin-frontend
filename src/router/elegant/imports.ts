...
export const views: Record<LastLevelRouteKey, RouteComponent | (() => Promise<RouteComponent>)> = {
  ...
  server_container: () => import("@/views/server/container/index.vue"),
  server_dashboard: () => import("@/views/server/dashboard/index.vue"),
  "server_database-detail": () => import("@/views/server/database-detail/index.vue"),
  server_database: () => import("@/views/server/database/index.vue"),
